...
pub fn create_human() // -> Result<()>
{
    ...
    for i in 0..50 {
        ...
        insert_comm.push_str(","); // have to remove the last one

        number_of_creation+=1;
        
    }

    insert_comm.push_str(";END"); //to end the Vec<&str>
    ...
    for i in 0..50 {
        ...
        insert_mecene.push_str(","); // have to remove the last one

        number_of_creation+=1;
        
    }

    insert_mecene.push_str(";END"); //to end the Vec<&str>
